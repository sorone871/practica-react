...
const Hero = () =>{
    ...
    return(
        <main className="h-screen w-auto flex flex-col-reverse bg-[#FAFAFA]  md:flex-row ">
            ...
            bg-[url(/practica-react/images/bg-intro-mobile.svg)] bg-no-repeat  bg-position-[left_bottom_-7rem] bg-[length:100%]

            md:bg-[url(/practica-react/images/bg-intro-desktop.svg)] md:bg-no-repeat  md:bg-position-[left_bottom_-5rem] md:bg-[length:176%] md:h-screen
            ">
